#!/usr/bin/env node
import { version, ENCRYPTION_KEY, installTemplateFromDefaultRepo, installPackageFromRepo, installAllDependencies, uninstallPackage, createNewApmPackage, installFromApmFile, viewApmFileContent, listPackages, runScript, createAperiumJson, ensureSudo, APERIUM_INSTALLED_PACKAGES_DIR, DEFAULT_REPO_URL } from './core.js';
